...
<head>
    ...
    <title>Kuis 3 - Sistem Pertahanan Tubuh</title>
...
<body>
    ...
    <div class="quiz-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1><i class="fas fa-microscope"></i> Kuis 3: Sistem Pertahanan Tubuh Tingkat Lanjut</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <!-- Quiz Form -->
                <form id="quizForm" method="POST" action="{{ route('kuis3.submit') }}">
                    @csrf
    ...
    <script>
        ...
        function autoSave() {
            ...
            localStorage.setItem('kuis3_answers', JSON.stringify(answers));
        }

        // Load saved answers
        function loadSavedAnswers() {
            const saved = localStorage.getItem('kuis3_answers');
            if (saved) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if(session('success'))
                localStorage.removeItem('kuis3_answers');
            @endif
        });
