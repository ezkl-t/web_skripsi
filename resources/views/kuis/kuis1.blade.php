...
<head>
    ...
    <title>Kuis 1 - Sistem Pertahanan Tubuh</title>
...
<body>
    ...
    <div class="quiz-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1><i class="fas fa-brain"></i> Kuis 1: Sistem Pertahanan Tubuh</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <!-- Quiz Form -->
                <form id="quizForm" method="POST" action="/kuis/submit">
                    @csrf
    ...
    <script>
        ...
        function autoSave() {
            ...
            localStorage.setItem('kuis1_answers', JSON.stringify(answers));
        }

        // Load saved answers
        function loadSavedAnswers() {
            const saved = localStorage.getItem('kuis1_answers');
            if (saved) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if(session('success'))
                localStorage.removeItem('kuis1_answers');
            @endif
        });
