    ...
    <div class="card-kesimpulan">
        ...
        <div class="materi-kesimpulan">
            ...
            <ul style="margin-left: 20px; margin-bottom: 15px;">
                <li>Perbedaan imunitas aktif dan pasif</li>
                <li>Berbagai kelainan pada sistem pertahanan tubuh</li>
                <li>Penyebab Kelainan pada Sistem Pertahanan Tubuh</li>
        ...
        <form id="form-kesimpulan">
            <div class="form-group">
                ...
                <textarea 
                    ...
                    placeholder="Berdasarkan materi yang telah saya pelajari tentang Imunitas Tubuh dan Kelainannya, saya dapat menyimpulkan bahwa..."
                    maxlength="1000"
                    required
                ></textarea>
