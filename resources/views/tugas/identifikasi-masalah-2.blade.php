...
<h2 class="card-title text-primary mb-4">Identifikasi Masalah</h2>
...
<table>
    ...
    <tr>
        <td>1. Di mana Leukosit dibuat?</td>
    ...
    <tr>
        <td>2. Apa saja bagian dari Fagosit?</td>
    ...
    <tr>
        <td>3. Apa peran dari Limfosit dalam melawan infeksi?</td>
    ...
    <tr>
        <td>4. Bagaimana Sistem Komplemen bekerja membantu sistem pertahanan tubuh?</td>
    ...
    <tr>
        <td>5. Apa yang terjadi jika sistem imun tidak berfungsi dengan baik?</td>
...
{{-- <body>
    ...
    <p class="materi">
        Dari video tersebut identifikasi masalah yang relevan untuk ditemukan pada solusi permasalahan pembahasan jenis Sel Darah Putih
    </p>
<table>
<tr>
    <th>Identifikasi Masalah</th>
