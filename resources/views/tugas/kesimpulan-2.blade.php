    ...
    <div class="card-kesimpulan">
        ...
        <div class="materi-kesimpulan">
            ...
            <ul style="margin-left: 20px; margin-bottom: 15px;">
                <li>Cara tubuh merespon infeksi patogen</li>
                <li>Perbedaan fagosit dan limfosit</li>
                <li>Peran limfosit B dan T dalam respon imun tubuh</li>
        ...
        <form id="form-kesimpulan">
            <div class="form-group">
                ...
                <textarea 
                    ...
                    placeholder="Berdasarkan materi yang telah saya pelajari tentang Komponen Sistem Pertahanan Tubuh, saya dapat menyimpulkan bahwa..."
                    maxlength="1000"
                    required
                ></textarea>
